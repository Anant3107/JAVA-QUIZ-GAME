...
public class Quiz extends JFrame implements ActionListener {
    ...
    Quiz (String username){
        ...
        next.setBackground(new Color(30, 90, 255));
        next.setForeground(Color.WHITE);
        next.addActionListener(this);
        next.setBounds(900, 430, 200, 40);
        add(next);
        
        lifeline= new JButton("50-50 Lifeline");
        lifeline.setFont(new Font("Tahoma",Font.PLAIN,22));
        lifeline.setBackground(new Color(30, 90, 255));
        ...
        submit.setBackground(new Color(30, 90, 255));
    ...
    public void paint(Graphics g){
        super.paint(g);
       String time="Time Left - "+timer+ " secs";
       g.setColor(Color.red);
       g.setFont(new Font("Tahoma", Font.BOLD,25));
     
       if(timer>0){
            g.drawString(time,930,400);
       } else{
                    g.drawString("TIMES UP !!",930, 400);
                    }
       timer--;
               try{
                   Thread.sleep(1000);
